  ...
  const [posts, setPosts] = useState([
    {
      ...
      title: "Post Title",
      username: "Username",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vel dolor nunc. Nunc rhoncus venenatis augue vitae tempor. Nulla malesuada libero magna, sit amet eleifend nunc tincidunt at.",
    },
    {
      id: 2,
      title: "Post Title",
      username: "Username",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vel dolor nunc. Nunc rhoncus venenatis augue vitae tempor.",
    },
    {
      id: 3,
      title: "Post Title",
    ...
    <Layout>
      ...
      <div className="w-full max-w-5xl mx-auto pt-6 pb-20 space-y-8">
        ...
        <div className="space-y-4">
          <h1 className="text-3xl font-bold text-white">Forum Pending Approval</h1>
