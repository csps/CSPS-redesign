...
export function Chart() {
  ...
  return (
    <div style={{ padding: '10px', fontFamily: 'Arial, sans-serif' }}> {/* Adjusted container width */}
      {/* Header */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <h3 style={{ fontSize: '14px' }}>Total Orders 8</h3>  {/* Smaller font size for header */}
        <select 
          value={timeRange} 
          onChange={handleDropdownChange} 
          style={{ padding: '3px', fontSize: '12px' }}> {/* Smaller font size for dropdown */}
      ...
      {/* Line Chart */}
      <div style={{ marginTop: '10px' }}> {/* Smaller chart container */}
