        ...
        {isOpen && (
          ...
          >
            ...
            <nav className="mt-4 xs:mt-5 sm:mt-6">
              ...
              {student && (
                <div className="mt-6 xs:mt-7 sm:mt-8 pt-4 xs:pt-5 sm:pt-6 border-t border-white/10 flex gap-2 xs:gap-3 items-center">
                  <div className="h-10 xs:h-11 w-10 xs:w-11 sm:h-12 sm:w-12 bg-purple-700/40 rounded-md flex-shrink-0" />
