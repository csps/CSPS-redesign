...
const GlassButton: React.FC<GlassButtonProps> = ({
  ...
  return (
    ...
    >
      {/* Glassy background */}
      <span className={`absolute inset-0 rounded-${borderType} backdrop-blur-[6px] border border-white/10  shadow-md group-hover:border-white/20 transition-all duration-200`}></span>
